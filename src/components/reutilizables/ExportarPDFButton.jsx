...
const ExportarPDFButton = ({ ruta }) => {
    ...
    const exportar = async () => {
        try {
            ...
            if (!response.ok) {
                ...
                console.error(`Error al obtener el PDF. Código: ${response.status}`);
                return;
            }

            // Convierte la respuesta a un blob que contiene el PDF
    ...
    return (
        ...
        <button type="button" className="btn btn-success" onClick={exportar}>
